...
var userCollections *mongo.Collection = database.OpenCollection("users")
...
return  func(c *gin.Context)  {
  ...
  if err !=nil {
	c.JSON(http.StatusBadRequest, gin.H{"error": "Unable to hashed Password             "})
  }
...
return 
  ...
  result , err := userCollections.InsertOne(ctx, user)
  if err != nil {
